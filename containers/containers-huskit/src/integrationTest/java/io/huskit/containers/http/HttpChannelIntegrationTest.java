...
public class HttpChannelIntegrationTest implements DockerIntegrationTest {
...
//        );
    ...
    @SneakyThrows
    private void useSubject(HttpChannel subject, ThrowingConsumer<HttpChannel> action) {
        try {
